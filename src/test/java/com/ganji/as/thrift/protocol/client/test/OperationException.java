...
public class OperationException extends Exception implements org.apache.thrift.TBase<OperationException, OperationException._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new OperationExceptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OperationExceptionTupleSchemeFactory());
  }
  ...
  public OperationException setMsg(String msg) {
    this.msg = msg;
    return this;
  }
  ...
  public int compareTo(OperationException other) {
    ...
    OperationException typedOther = (OperationException)other;
  ...
  private static class OperationExceptionStandardSchemeFactory implements SchemeFactory {
    public OperationExceptionStandardScheme getScheme() {
      return new OperationExceptionStandardScheme();
    }
  }

  private static class OperationExceptionStandardScheme extends StandardScheme<OperationException> {
  ...
  private static class OperationExceptionTupleSchemeFactory implements SchemeFactory {
    public OperationExceptionTupleScheme getScheme() {
      return new OperationExceptionTupleScheme();
    }
  }

  private static class OperationExceptionTupleScheme extends TupleScheme<OperationException> {
